...
This chapter introduces the study and lays out the ground the rest of the thesis builds on. It opens with the background of the study, which traces how generative AI image tools entered the design workflow, why the text they render arrives deformed, and why existing font-recognition tools fail on exactly that input. From that ground, the chapter states the problem the study addresses, sets out its general and specific objectives, and poses the research questions the later chapters answer. It closes by drawing the scope and limitations of the work and by identifying the stakeholders to whom its results matter. Technical concepts appear in this chapter only as far as the problem requires them; their full treatment belongs to Chapter 3.
