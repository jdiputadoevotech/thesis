...
Dear \<Last Name of the Expert\>,

Greetings!

We respectfully request your participation as an **expert evaluator and consultant** for our thesis project entitled *"Addressing Typographic Hallucination in Generative AI Images: An Open-Set Metric Learning Approach to Font Style Recognition."* Generative AI image tools (e.g., DALL·E, Midjourney) render text with *typographic hallucinations* — warped glyphs, irregular kerning, and character smearing — that cause commercial font identifiers to fail. Our system applies a deep-learning metric-learning pipeline that matches such distorted text to the closest open-source Google Font, enabling free template reconstruction.
...
Matt Cabarrubias		Ritchie Diputado

\<Student Complete Name & Signature\>		\<Student Complete Name & Signature\>

Noted by:

\<Thesis Adviser Complete Name\>
